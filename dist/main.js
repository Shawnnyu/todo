...
class FormHandlers {
  ...
  static taskFormSubmit() {
    ...
    const task = new _task_js__WEBPACK_IMPORTED_MODULE_2__["default"](newTaskTitle.value, newTaskDescription.value, (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date(), "yyyy-MM-dd"), "date", "important", false);
    const currentProject = _storage_js__WEBPACK_IMPORTED_MODULE_1__["default"].getProjectObject(_loadPage_js__WEBPACK_IMPORTED_MODULE_0__.getCurrentProject());
    _storage_js__WEBPACK_IMPORTED_MODULE_1__["default"].addTaskToProject(currentProject, task);
    _loadPage_js__WEBPACK_IMPORTED_MODULE_0__.loadTaskDisplay(currentProject);
  }
  ...
  static taskFormSubmit1(project) {
    ...
    const newTaskDescription = document.querySelector("#new-task-description");
    const task = new _task_js__WEBPACK_IMPORTED_MODULE_2__["default"](newTaskTitle.value, newTaskDescription.value, (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date(), "yyyy-MM-dd"), "date", "important", false);
    const currentProject = _storage_js__WEBPACK_IMPORTED_MODULE_1__["default"].getProjectObject(project);
    _storage_js__WEBPACK_IMPORTED_MODULE_1__["default"].addTaskToProject(currentProject, task);
    _loadPage_js__WEBPACK_IMPORTED_MODULE_0__.loadTaskDisplay(currentProject);
  }
  ...
  static projectFormSubmit(e) {
    ...
    const project = new _project_js__WEBPACK_IMPORTED_MODULE_3__["default"](newProjectTitle.value);
    _storage_js__WEBPACK_IMPORTED_MODULE_1__["default"].addProject(project);

    //remove below
    //Page.loadSideBarProjects();
    _loadPage_js__WEBPACK_IMPORTED_MODULE_0__.addProjectToSideBar(project);
    _loadPage_js__WEBPACK_IMPORTED_MODULE_0__.hideProjectForm();
    console.log("title: ");
  }

  static removeTask(project, task, isInbox) {
    _storage_js__WEBPACK_IMPORTED_MODULE_1__["default"].deleteTaskFromProject(project, task);
    if (isInbox) {
      _loadPage_js__WEBPACK_IMPORTED_MODULE_0__.loadInbox();
    } else {
      _loadPage_js__WEBPACK_IMPORTED_MODULE_0__.loadTaskDisplay(project);
    }
  }
}
...
function loadSideBarProjects() {
  ...
  for (let i = 0; i < allProjects.length; i++) {
    ...
    //fix below
    item.onclick = () => loadProjectFromSidebar(_storage_js__WEBPACK_IMPORTED_MODULE_2__["default"].getProjectObject(allProjects[i]));
...
function loadInbox() {
  ...
  projectTitleDisplay.appendChild((0,_util__WEBPACK_IMPORTED_MODULE_0__.generateContent)("h2", "Inbox"));
  const allProjects = _storage_js__WEBPACK_IMPORTED_MODULE_2__["default"].getAllProjects();
  for (let i = 0; i < allProjects.length; i++) {
...
function loadTask(project, t, isInbox) {
  ...
  task.appendChild((0,_util__WEBPACK_IMPORTED_MODULE_0__.generateContent)("p", t.title));
  task.appendChild((0,_util__WEBPACK_IMPORTED_MODULE_0__.generateContent)("p", t.description));
  task.appendChild((0,_util__WEBPACK_IMPORTED_MODULE_0__.generateContent)("p", t.createdDate));

  const deleteBtn = document.createElement("button");
  //deleteBtn.innerText = "X";
  deleteBtn.classList.add("delete-btn");
  deleteBtn.onclick = () => _formHandlers_js__WEBPACK_IMPORTED_MODULE_1__["default"].removeTask(project, t, isInbox);
...
function loadProjectFromSidebar(project) {
  ...
  projectTitleDisplay.appendChild((0,_util__WEBPACK_IMPORTED_MODULE_0__.generateContent)("h2", project.title));
  (0,_util__WEBPACK_IMPORTED_MODULE_0__.removeChildren)(tasksList);
...
//load stuff
_loadPage__WEBPACK_IMPORTED_MODULE_2__.loadSidebarButtons();
//Page.loadTaskButtons();

const p1t1 = new _task__WEBPACK_IMPORTED_MODULE_0__["default"]("p1one", "oneDes", (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date(), "yyyy-MM-dd"), "date", "important", false);
const p1t2 = new _task__WEBPACK_IMPORTED_MODULE_0__["default"]("p1two", "twoDes", (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date(), "yyyy-MM-dd"), "date", "important", false);

const p2t1 = new _task__WEBPACK_IMPORTED_MODULE_0__["default"]("p2one", "oneDes", (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date(), "yyyy-MM-dd"), "date", "important", false);
const p2t2 = new _task__WEBPACK_IMPORTED_MODULE_0__["default"]("p2two", "twoDes", (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date(), "yyyy-MM-dd"), "date", "important", false);

const p1 = new _project__WEBPACK_IMPORTED_MODULE_1__["default"]("project 1");
const p2 = new _project__WEBPACK_IMPORTED_MODULE_1__["default"]("project 2");
const p3 = new _project__WEBPACK_IMPORTED_MODULE_1__["default"]("project 3");
...
p2.addTask(p2t2);
//Page.loadProject(p1);
//console.log(getProject(p1.title));

_storage__WEBPACK_IMPORTED_MODULE_3__["default"].addProject(p1);

_storage__WEBPACK_IMPORTED_MODULE_3__["default"].addProject(p2);

_storage__WEBPACK_IMPORTED_MODULE_3__["default"].addProject(p3);

//console.log(p1);

//const testP1 = getProjectObject(p1.title);
//console.log(testP1);

_loadPage__WEBPACK_IMPORTED_MODULE_2__.loadInbox();
_loadPage__WEBPACK_IMPORTED_MODULE_2__.loadSideBarProjects();
//const p1Retrieved = getProject(p1.title);
//const p1JsonParsed = JSON.parse(p1Retrieved);
//console.log(p1JsonParsed);
//console.log(p1JsonParsed[0]["dueDate"]);

//const map = new Map(Object.entries(JSON.parse(p1Retrieved)));
//console.log(map.get("0"));

//todo
//Add rules to project and task forms
//make many projects to break page
//inbox, day, week
